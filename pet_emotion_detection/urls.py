"""
URL configuration for pet_emotion_detection project.
...
schema_view = get_schema_view(
    openapi.Info(
        title="Pet Emotion Detection API",
        default_version='v1',
        description="API documentation for Pet Emotion Detection application",
        terms_of_service="https://www.google.com/policies/terms/",
        contact=openapi.Contact(email="contact@petmood.local"),
